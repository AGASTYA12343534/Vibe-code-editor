...
export function DashboardSidebar({ initialPlaygroundData }: { initialPlaygroundData: PlaygroundData[] }) {
  ...
  return (
    <Sidebar variant="inset" collapsible="icon" className="border-r border-white/10 bg-[#0A0A0A] text-zinc-300">
      <SidebarHeader className="border-b border-white/5 pb-4 mb-2">
        <div className="flex items-center gap-3 px-4 py-3">
          <div className="relative group">
            ...
            <Image src={"/logo.svg"} alt="Forge logo" height={40} width={40} className="relative z-10 drop-shadow-md" />
          </div>
          <div className="flex flex-col group-data-[collapsible=icon]:hidden">
            <span className="font-bold text-lg tracking-wider text-white">FORGE</span>
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-mono">Workspace</span>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
